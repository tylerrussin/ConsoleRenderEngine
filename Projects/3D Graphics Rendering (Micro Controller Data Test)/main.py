...
if __name__ == '__main__':
    ...
    while 1:
        ...
        x_angle += dy * 0.5  # vertical movement controls pitch
        z_angle += dx * 0.5  # horizontal movement controls yaw

        # Rotation Z and X projection matrices
        mat_rot_z = matrices.make_rotation_z(math.radians(z_angle))
        mat_rot_x = matrices.make_rotation_x(math.radians(x_angle))
